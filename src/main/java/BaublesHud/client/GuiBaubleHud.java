...
public class GuiBaubleHud{
	
	public static GuiBaubleHud instancemain = new GuiBaubleHud();
	...
	public void drawbaublesHud(ScaledResolution res)
	{
		...
		if (stack0 !=null)
		{
			...
			RenderItem.getInstance().renderItemIntoGUI(mc.fontRenderer, mc.renderEngine, new ItemStack (item0), LocX + 5, LocY + 100);
		}
		...
		if (stack1 !=null)
		{
			...
			RenderItem.getInstance().renderItemIntoGUI(mc.fontRenderer, mc.renderEngine, new ItemStack (item1), LocX + 5, LocY + 120);
		}
		...
		if (stack2 !=null)
		{
			...
			RenderItem.getInstance().renderItemIntoGUI(mc.fontRenderer, mc.renderEngine, new ItemStack (item2), LocX + 5, LocY + 140);
		}
		...
		if (stack3 !=null)
		{
			...
			RenderItem.getInstance().renderItemIntoGUI(mc.fontRenderer, mc.renderEngine, new ItemStack (item3), LocX + 5, LocY + 160);
		}
